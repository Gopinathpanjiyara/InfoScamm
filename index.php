    ...
    <script>
      ...
      <style>
        .ifr {
          ...
          padding-bottom: 20px;
          display: flex;
          flex-direction: row; /* Updated to stack items horizontally */
        ...
        .ifr iframe {
          ...
          margin-bottom: 10px; /* Add some space between card and iframe */
        }
      
        @media (max-width: 768px) {
          .ifr {
            flex-direction: column; /* Updated to stack items vertically on mobile */
          }
